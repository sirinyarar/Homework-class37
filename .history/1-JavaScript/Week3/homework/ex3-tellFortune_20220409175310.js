...
function selectRandomly(jobTitles, locations, partnerNames, numKids) {
    // TODO complete this function
    let randomJob = jobTitles[Math.floor(Math.random() * jobTitles.length)];
    ...
    let randomKidNum = numKids[Math.floor(Math.random() * numKids.length)];
}
